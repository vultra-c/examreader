...
class InterHandshake(context: Context, val scope: CoroutineScope) : Interconn(context) {
    ...
    companion object {
        ...
        private const val PHONE_VERSION_CODE = 126430
        private const val MIN_BAND_VERSION_CODE = 260418
        const val MIN_BAND_VERSION = "V26.4.0"
    }
    ...
    private var onVersionIncompatible: (currentVersion: Int, requiredVersion: Int, requiredVersionName: String) -> Unit =
        { _, _, _ -> }

    fun setOnVersionIncompatible(callback: (currentVersion: Int, requiredVersion: Int, requiredVersionName: String) -> Unit) {
